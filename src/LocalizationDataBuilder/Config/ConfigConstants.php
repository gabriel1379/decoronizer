...
interface ConfigConstants
{
    ...
    public const FILENAME_SOURCE_CSV = 'PATH_SOURCE_CSV';
    public const FILENAME_MSG_MASTER = 'PATH_MSG_MASTER';
    public const FILENAME_MSG_DESTINATION = 'PATH_MSG_DESTINATION';
